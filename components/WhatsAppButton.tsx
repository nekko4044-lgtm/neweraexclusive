...
const IG_RU      = 'https://www.instagram.com/newera_uae/'
const IG_INTL    = 'https://www.instagram.com/newera.uae/'
...
export default function WhatsAppButton() {
  ...
  const igUrl = locale === 'ru' ? IG_RU : IG_INTL
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">

      {/* Instagram */}
      <SocialBtn href={igUrl} label="Instagram">
